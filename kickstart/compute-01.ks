...
network --onboot yes --device eth0 --bootproto static --ip=10.0.0.31 --netmask 255.255.255.0 
network --onboot yes --device eth2 --bootproto static --ip=10.0.1.31 --netmask 255.255.255.0
...
sed -i "s/#id:/id: compute-01/" /etc/salt/minion
