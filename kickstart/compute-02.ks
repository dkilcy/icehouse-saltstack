...
network --onboot yes --device eth0 --bootproto static --ip=10.0.0.32 --netmask 255.255.255.0 
network --onboot yes --device eth2 --bootproto static --ip=10.0.1.32 --netmask 255.255.255.0
...
sed -i "s/#id:/id: compute-02/" /etc/salt/minion
